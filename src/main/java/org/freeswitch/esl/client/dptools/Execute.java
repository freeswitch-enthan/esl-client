...
public class Execute {
     ...
     * @param path any sound format FreeSWITCH supports, wav, local_steam, shout
     * etc.
     * @param flags flags to stream, null if none
     * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_displace_session">
     * http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_displace_session
     * </a>
     */
     ...
     * etc.
     * @param flags flags to stream, null if none
     * @param timeLimitMillis optional time limit, 0 for none
     * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_displace_session">
     * http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_displace_session
     * </a>
     */
     ...
     * next channel.
     * @param uuid uuid of the call or 'all' for all
     * @param groupId if specified, eavesdrop only works with channels that have an
     ...
     * @param groupId if specified, eavesdrop only works with channels that have an
     * "eavesdrop_group" channel variable set to the same name.
     * @param failedWav ex: /sounds/failed.wav
     * @param newChannelWav ex: /sounds/new_chan_announce.wav
     * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_eavesdrop">
     * http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_eavesdrop
     * </a>
     */
     ...
     * @param failedWav ex: /sounds/failed.wav
     * @param newChannelWav ex: /sounds/new_chan_announce.wav
     * @param idleWav ex: /sounds/idle.wav
     * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_eavesdrop">
     * http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_eavesdrop
     * </a>
     */
     ...
     * Generate TGML tones.
     * @param tone ex: Generate a 500ms beep at 800Hz, tone = "%(500,0,800)"
     * @param loops set to a non zero nuber, -1 for infinate loop
     * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_gentones">
     * http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_gentones
     * </a>
     * @see <a href="http://wiki.freeswitch.org/wiki/TGML">
    ...
    /**
     * Manage the audio being played into a channel from a sound file
     * @param samples <+[samples]>|<-[samples]> Samples are the literally the number
     ...
     * method(s) configured on the endpoint in use. use the character w for a .5
     * second delay and the character W for a 1 second delay.
     * @param durationsMillis ignored if <=0
     * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_queue_dtmf">
     * http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_queue_dtmf
     * </a>
     */
     ...
     * Record is used for recording messages, like in a voicemail system. This
     * application will record a file to file
     * @param timeLimitSeconds the maximum duration of the recording.
     * @param silenceThreshold is the energy level.
     ...
     * @param silenceHits how many positive hits on being below that thresh you can
     ...
     * @param recordTile store in the file header meta data (provided the file format
     * supports meta headers).
     * @param recordCopyright store in the file header meta data (provided the file format
     * supports meta headers).
     * @param recordSoftware store in the file header meta data (provided the file format
     * supports meta headers).
     * @param recordArtist store in the file header meta data (provided the file format
     * supports meta headers).
     * @param recordComment store in the file header meta data (provided the file format
     * supports meta headers).
     * @param recordDate store in the file header meta data (provided the file format
     * supports meta headers).
     * @param recordRate the sample rate of the recording.
     * @see <a href="http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_record">
     * http://wiki.freeswitch.org/wiki/Misc._Dialplan_Tools_record
     * </a>
     */
     ...
     * @param sayMethod Say method is one of the following N/A PRONOUNCED ITERATED
     * COUNTED
     * @param gender Say gender is one of the following (For languages with
     ...
     * future
     * @param interval is the param seconds an epoc time or interval
     * @param cause ex:allotted_timeout
     */
